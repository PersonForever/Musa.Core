...
NTSYSAPI
BOOLEAN
NTAPI RtlGetInterruptTime(_Out_ PLARGE_INTEGER InterruptTime);

NTSYSAPI
NTSTATUS
NTAPI
RtlQueryAuxiliaryCounterFrequency(_Out_ PULONG64 AuxiliaryCounterFrequency);

NTSYSAPI
NTSTATUS
NTAPI
RtlConvertAuxiliaryCounterToPerformanceCounter(
...
NTSTATUS
NTAPI
RtlConvertPerformanceCounterToAuxiliaryCounter(
...
{
    return !!RtlQueryUnbiasedInterruptTime(reinterpret_cast<PLARGE_INTEGER>(UnbiasedTime)).QuadPart;
}
