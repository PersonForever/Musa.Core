...
BOOL WINAPI MUSA_NAME(IsDebuggerPresent)(VOID)
{
    return RtlIsAnyDebuggerPresent();
}

MUSA_IAT_SYMBOL(IsDebuggerPresent, 0);

VOID WINAPI MUSA_NAME(DebugBreak)(VOID)
{
    __debugbreak();
}

MUSA_IAT_SYMBOL(DebugBreak, 0);

VOID WINAPI MUSA_NAME(OutputDebugStringA)(
...
VOID WINAPI MUSA_NAME(OutputDebugStringW)(
...
BOOL WINAPI MUSA_NAME(FormatMessageA)(
    _In_ DWORD       Flags,
    _In_opt_ LPCVOID Source,
    _In_ DWORD       MessageId,
    _In_ DWORD       LanguageId,
...
MUSA_IAT_SYMBOL(FormatMessageA, 28);

BOOL WINAPI MUSA_NAME(FormatMessageW)(
    _In_ DWORD       Flags,
    _In_opt_ LPCVOID Source,
    _In_ DWORD       MessageId,
    _In_ DWORD       LanguageId,
